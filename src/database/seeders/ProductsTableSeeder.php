    ...
    public function run()
    {
        $products = [
            [
                ...
                'season' => json_encode(['秋', '冬']),
                'dummy_image' => 'kiwi.png',
            ],
            [
                'name' => 'ストロベリー',
                'price' => 1200,
            ...
            [
                ...
                'season' => json_encode(['春', '夏']),
                'dummy_image' => 'melon.png',
            ],
        ];

        // imageカラムにdummy_imageをコピーして挿入
        foreach ($products as &$product) {
            $product['image'] = $product['dummy_image'];
        }
